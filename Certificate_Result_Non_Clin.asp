...
<link rel="File-List" href="Certificate_Result_Non_Clin_files/filelist.xml">
<title>RN Cert</title>
<style>
<!--
h2
...
<table border="10" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" bordercolorlight="#C0C0C0" bordercolordark="#9999FF">
 ...
 <v:imagedata src="" o:title="CDR 96-15" gain="55050f" blacklevel="2621f"/>
    ...
    <p class="MsoNormal" align="center" style="text-align: center">
	<span style="font-size: 14.0pt">This continuing education program awards 1.0 
	credits for nurses, case managers, social workers and registered dietitians.</span></p>
	<p class="MsoNormal" align="center" style="text-align: center">
	<span style="font-size: 14.0pt; letter-spacing: 1.0pt">This certificate must 
	be retained by the recipient for a minimum of four years from date printed 
	on face.</span></p>
