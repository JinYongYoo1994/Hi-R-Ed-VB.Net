...
function FrontPage_Form1_Validator(theForm)
{
  ...
  var checkOK = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzƒŠŒšœŸÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõöøùúûüışÿ- \t\r\n\f";
  ...
  if (theForm.Contact_CredentialsLicenseNo.value == "")
  {
    alert("Please enter a value for the \"Contact_CredentialsLicenseNo\" field.");
    theForm.Contact_CredentialsLicenseNo.focus();
    return (false);
  }

  if (theForm.Contact_CredentialsLicenseNo.value.length < 4)
  {
    alert("Please enter at least 4 characters in the \"Contact_CredentialsLicenseNo\" field.");
    theForm.Contact_CredentialsLicenseNo.focus();
    return (false);
  }

  if (theForm.Contact_CredentialsLicenseNo.value.length > 20)
  {
    alert("Please enter at most 20 characters in the \"Contact_CredentialsLicenseNo\" field.");
    theForm.Contact_CredentialsLicenseNo.focus();
    return (false);
  }
  ...
  var checkStr = theForm.Contact_CredentialsLicenseNo.value;
  var allValid = true;
  var validGroups = true;
  for (i = 0;  i < checkStr.length;  i++)
  {
  ...
  if (!allValid)
  {
    alert("Please enter only letter, digit, whitespace and \"-,/\" characters in the \"Contact_CredentialsLicenseNo\" field.");
    theForm.Contact_CredentialsLicenseNo.focus();
    return (false);
  }
  ...
  {
    alert("Please enter a value for the \"user_name\" field.");
  ...
  {
    alert("Please enter at least 3 characters in the \"user_name\" field.");
    theForm.user_name.focus();
    return (false);
  }
  ...
  if (!allValid)
  {
    alert("Please enter only letter, whitespace and \"-,.\" characters in the \"user_name\" field.");
    theForm.user_name.focus();
    return (false);
  }
...
//--></script><!--webbot BOT="GeneratedScript" endspan --><FORM METHOD="POST" ACTION="CertInfoForm-OAB_RN.asp" name="FrontPage_Form1" onSubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" webbot-action="--WEBBOT-SELF--">
<!--webbot bot="SaveResults" U-File="../_private/RN cert info form/OAB-RN_form_results.csv" S-Format="TEXT/CSV" S-Label-Fields="TRUE" B-Reverse-Chronology="TRUE" S-Date-Format="%m/%d/%y" S-Time-Format="%I:%M %p" S-Builtin-Fields="REMOTE_NAME REMOTE_USER HTTP_USER_AGENT Date Time" U-Confirmation-Url="../Congrats certs/Congrats_OAB_RN.htm" startspan --><input TYPE="hidden" NAME="VTI-GROUP" VALUE="0"><!--webbot bot="SaveResults" endspan i-checksum="43374" --><P>
<b>
<font color="#FFFFFF">Please enter the following information as you would like 
...
<TD width="295" height="23">
<!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-,/" b-value-required="TRUE" i-minimum-length="4" i-maximum-length="20" --><INPUT NAME="Contact_CredentialsLicenseNo" SIZE=25 tabindex="4" maxlength="20">
</TD>
</TR>
<tr>
<TD ALIGN="right" width="180" height="23">
...
<tr>
<TD ALIGN="right" width="180" height="23">
<font color="#FFFFFF"><i><b>User Name  </b><font size="2">(used in addition to 
the&nbsp; password given to you for course access)</font></i></font>&nbsp;</TD>
<TD width="295" height="23">
<!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-,." b-value-required="TRUE" i-minimum-length="3" --><input type="text" name="user_name" size="25" tabindex="6"></TD>
</tr>
<tr>
<TD ALIGN="right" width="180" height="23">
<b>
...
<font size="1">RFG Hi-<i>R</i>-Ed2.<br>Copyright © 2013 Hi-<i>R</i>-Ed.org. All rights reserved. <BR>
Revised: 
<!--WEBBOT BOT=TimeStamp
    S-Type="EDITED"
    S-Format="%m/%d/%y" startspan
-->10/11/19<!--webbot bot="TimeStamp" i-checksum="13445" endspan --></font></span></H5>
</BODY>
</HTML>